...
namespace FSharp.ProjectExtender
{
    ...
    public class Factory : FlavoredProjectFactoryBase, IVsSolutionEvents
    {
        ...
        private const string FixerWarning = "Project {0} ({1}) seems to be a corrupted F# Project Extender project.\n\nSelect Fix and Reload from the Project context menu to fix it";
