...
namespace FSharp.ProjectExtender
{
    ...
    [ProvideProjectFactory(typeof(Factory), "ProjectExtender", null, null, null, ".\\NullPath", LanguageVsTemplate = "FSharp")]
    // Provide object so it can be created through the ILocalRegistry interface - in this case the new property page
    [ProvideObject(typeof(Page), RegisterUsing = RegistrationMethod.CodeBase)]
    ...
    public sealed class ProjectExtenderPackage : Package
    {
        ...
        protected override void Initialize()
        {
            ...
            mcs.AddCommand(new Commands.FixNReload());
        }
